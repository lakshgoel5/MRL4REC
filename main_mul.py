...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch):
        ...
        if epoch % 5 == 0:
            ...
            if args.early_stop:
                cur_best_pre_0, stopping_step, should_stop = early_stopping(valid_ret['recall'][0], cur_best_pre_0, stopping_step, expected_order='acc', flag_step=args.stopping_steps)
                if should_stop:
                    break
